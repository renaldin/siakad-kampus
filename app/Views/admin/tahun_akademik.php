                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-info btn-sm btn-flat" data-toggle="modal" data-target="#edit<?= $ta['id_tahun_akademik']; ?>"><i class="fa fa-pencil"></i></button>
                                <button class="btn btn-danger btn-sm btn-flat" data-toggle="modal" data-target="#delete<?= $ta['id_tahun_akademik']; ?>"><i class="fa fa-trash"></i></button>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
